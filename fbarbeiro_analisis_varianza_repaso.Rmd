...
```
<p style="text-align: justify">
La justificativa de mí elección ha sido porque individualmente los conjuntos de datos son de menos de 30 ítems y, aún seguiendo a López-Roldán y Fachelli (2015) [3] si n≤30 se tiene que verificar con la prueba estadística de normalidad de *Shapiro-Wilk*.
</p>
<br />

####4.1.4. Interpretar los resultados a partir del gráfico qqnorm y de los valores que devuelve el test.
Tomando el valor de significación &alpha;= `r alfa`.
